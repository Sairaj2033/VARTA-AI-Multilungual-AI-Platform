          ...
          <div className="flex items-center gap-2 lg:gap-4 min-w-0 flex-1">
            ...
            <div className="flex items-center gap-2 lg:gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <h1 className="text-lg lg:text-xl font-semibold text-gray-900 dark:text-white truncate">{title}</h1>
                <p className="text-xs lg:text-sm text-gray-500 dark:text-gray-400 truncate">{subtitle}</p>
              </div>
            </div>
          </div>
